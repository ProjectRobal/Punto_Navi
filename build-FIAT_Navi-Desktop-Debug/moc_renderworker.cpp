...
#include "../../FIAT_Navi/renderworker.h"
...
void RenderWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RenderWorker::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RenderWorker::resultReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RenderWorker::resultReady(const int _t1)
{
